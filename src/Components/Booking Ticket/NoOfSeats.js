...
const NoOfSeats = ({ ticketFormik }) => {
    return ( <
        div className = 'flex flex-col space-y-[35px] mt-[40px]' > { /* --------- 50 per persons -------- */ } <
        div className = 'flex items-center gap-[20px]' >
        <
        input value = { ticketFormik.values.indianCitizenNo }
        ...
        div className = 'flex items-center gap-[20px]' >
        <
        input value = { ticketFormik.values.foreignCitizenNo }
        onChange = { ticketFormik.handleChange }
        id = 'foreignCitizenNo'
        ...
        div className = 'flex items-center gap-[20px]' >
        <
        input value = { ticketFormik.values.indianStudentNo }
        onChange = { ticketFormik.handleChange }
        id = 'indianStudentNo'
        min = { 0 }
        type = { 'number' }
        ...
        div className = 'flex items-center gap-[20px]' >
        <
        input value = { ticketFormik.values.foreignStudentNo }
        onChange = { ticketFormik.handleChange }
        id = 'foreignStudentNo'
        min = { 0 }
